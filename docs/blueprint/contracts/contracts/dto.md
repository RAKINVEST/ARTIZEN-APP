...
> **Version** 1.0 — **Status** Frozen — **Owner** objet propriétaire — **Last Update** 2026-08-02
...
## Description
Contrat des objets échangés.

## Pourquoi existe-t-il
Projection stable d'un objet du Domain Model.

## Responsable
objet propriétaire (propriétaire unique du contrat).
...
## Valeurs autorisées
types normalisés ; montant en chaîne

## Valeurs interdites
DTO God ; champ orphelin
...
## Évolutions prévues
Ajout de champ optionnel = mineur
