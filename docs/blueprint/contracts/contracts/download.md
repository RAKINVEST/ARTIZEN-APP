...
> **Version** 1.0 — **Status** Frozen — **Owner** Storage/Media — **Last Update** 2026-08-02
...
## Description
Contrat de récupération de fichier.

## Pourquoi existe-t-il
Servir les octets, tenant-scopé.

## Responsable
Storage/Media (propriétaire unique du contrat).
...
## Valeurs interdites
URL publique d'un fichier privé
