...
## Description
Contrat des intentions d'écriture.

## Pourquoi existe-t-il
Exécuter une intention validée par l'artisan.
...
## Valeurs autorisées
idempotence protégée

## Valeurs interdites
décision autonome ; effet caché
...
## Erreurs possibles
validation_error, conflict, forbidden
