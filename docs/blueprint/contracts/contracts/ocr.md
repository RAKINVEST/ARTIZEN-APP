...
> **Version** 1.0 — **Status** Frozen — **Owner** OCR Engine — **Last Update** 2026-08-02
...
## Description
Contrat d'extraction texte d'image/PDF.

## Pourquoi existe-t-il
Lire un document existant.

## Responsable
OCR Engine (propriétaire unique du contrat).
