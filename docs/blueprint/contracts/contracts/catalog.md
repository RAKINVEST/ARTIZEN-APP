...
> **Version** 1.0 — **Status** Frozen — **Owner** Catalog Engine — **Last Update** 2026-08-02
...
## Description
Contrat de la bibliothèque métier.

## Pourquoi existe-t-il
Blocs réutilisables (article/kit/phrase).

## Responsable
Catalog Engine (propriétaire unique du contrat).
