...
> **Version** 1.0 — **Status** Frozen — **Owner** moteur propriétaire — **Last Update** 2026-08-02
...
## Description
Contrat des lectures sans effet.

## Pourquoi existe-t-il
Lire sans jamais modifier (CQRS léger).

## Responsable
moteur propriétaire (propriétaire unique du contrat).
