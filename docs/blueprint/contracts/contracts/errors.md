...
## Description
Contrat des erreurs normalisées.

## Pourquoi existe-t-il
Erreurs actionnables et traçables.
...
## Erreurs possibles
toutes (catalogue [../ERROR_CONTRACTS.md](../ERROR_CONTRACTS.md))
