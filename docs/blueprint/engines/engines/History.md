...
## Mission
Journaliser l'activité métier d'un objet (append-only).

## Vision
Historique permanent (Loi 4/5).

## Responsabilité unique
Journaliser l'activité métier d'un objet (append-only). — **une seule question**, aucune autre (Loi 1).
