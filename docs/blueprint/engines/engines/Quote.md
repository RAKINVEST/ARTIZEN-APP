...
> **Depends On:** [../ENGINE_MAP.md](../ENGINE_MAP.md) — **Used By:** engines, contracts, events — **Niveau:** 2 · Architecture · **Couche:** L4 Commercial

## Nom
Quote Engine

## Mission
Gérer les devis (projection commerciale).

## Vision
Le devis découle des interventions.

## Responsabilité unique
Gérer les devis (projection commerciale). — **une seule question**, aucune autre (Loi 1).

## Propriétaire
Commercial Documents (unique).
...
## Objets utilisés
Intervention, Customer, Catalog, PDF, Branding
...
## Changelog
- 1.0 (2026-08-02) — Fiche initiale (L4 Commercial).
