...
## Mission
Gérer les interventions (unité de pensée, Loi 8).

## Vision
Le logiciel pense comme un artisan.

## Responsabilité unique
Gérer les interventions (unité de pensée, Loi 8). — **une seule question**, aucune autre (Loi 1).
...
## Objets utilisés
Catalog, Kit, Phrase Library

## Objets interdits
Mission (ne la connaît pas)
