...
## Mission
Gérer les clients et leur carnet de santé.

## Vision
Un carnet unique par client.

## Responsabilité unique
Gérer les clients et leur carnet de santé. — **une seule question**, aucune autre (Loi 1).

## Propriétaire
Client & Carnet (unique).
