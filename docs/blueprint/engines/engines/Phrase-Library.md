...
## Mission
Gérer les phrases réutilisables.

## Vision
Une phrase écrite une fois, réutilisée partout.

## Responsabilité unique
Gérer les phrases réutilisables. — **une seule question**, aucune autre (Loi 1).
