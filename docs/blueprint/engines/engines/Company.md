...
> **Depends On:** [../ENGINE_MAP.md](../ENGINE_MAP.md) — **Used By:** engines, contracts, events — **Niveau:** 2 · Architecture · **Couche:** L1 Identité

## Nom
Company Engine

## Mission
Gérer l'entreprise et servir de racine de tenant.

## Vision
Le socle multi-entreprise.

## Responsabilité unique
Gérer l'entreprise et servir de racine de tenant. — **une seule question**, aucune autre (Loi 1).

## Propriétaire
Company Identity (unique).
...
## Changelog
- 1.0 (2026-08-02) — Fiche initiale (L1 Identité).
