...
## Mission
Adresser des messages d'attention (non bloquants).

## Vision
Un copilote discret (mode silencieux).

## Responsabilité unique
Adresser des messages d'attention (non bloquants). — **une seule question**, aucune autre (Loi 1).
