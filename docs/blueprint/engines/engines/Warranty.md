...
> **Depends On:** [../ENGINE_MAP.md](../ENGINE_MAP.md) — **Used By:** engines, contracts, events — **Niveau:** 2 · Architecture · **Couche:** L7 Field Ops

## Nom
Warranty Engine

## Mission
Gérer les garanties du matériel installé.

## Vision
Alerter avant, jamais après.

## Responsabilité unique
Gérer les garanties du matériel installé. — **une seule question**, aucune autre (Loi 1).

## Propriétaire
Field Ops (futur) (unique).
...
## Changelog
- 1.0 (2026-08-02) — Fiche initiale (L7 Field Ops).
