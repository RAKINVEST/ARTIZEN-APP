...
## Mission
Gérer les kits (préparations réutilisables).

## Vision
Composer sans logique.

## Responsabilité unique
Gérer les kits (préparations réutilisables). — **une seule question**, aucune autre (Loi 1).
