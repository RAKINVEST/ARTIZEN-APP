...
> **Note :** Alias de Performance (anti-patterns).

## Nom
Analytics Engine

## Mission
(Alias de Performance) analyses agrégées.

## Vision
Pas un moteur distinct.

## Responsabilité unique
(Alias de Performance) analyses agrégées. — **une seule question**, aucune autre (Loi 1).
