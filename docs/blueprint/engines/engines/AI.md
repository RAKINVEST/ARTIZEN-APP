...
> **Version** 1.0 — **Status** Frozen — **Owner** Plateforme — **Last Update** 2026-08-02
...
## Mission
Fournir des capacités IA (LLM/vision).

## Vision
L'IA enrichit, ne décide pas.

## Responsabilité unique
Fournir des capacités IA (LLM/vision). — **une seule question**, aucune autre (Loi 1).
