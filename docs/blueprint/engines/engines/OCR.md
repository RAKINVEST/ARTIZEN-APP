...
> **Note :** Sous-partie de Document Analysis (voir anti-patterns).
...
## Vision
Capacité interne de l'analyse.

## Responsabilité unique
Transformer une image en texte. — **une seule question**, aucune autre (Loi 1).
