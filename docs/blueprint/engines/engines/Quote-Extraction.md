...
> **Version** 1.0 — **Status** Frozen — **Owner** Import — **Last Update** 2026-08-02
> **Depends On:** [../ENGINE_MAP.md](../ENGINE_MAP.md) — **Used By:** engines, contracts, events — **Niveau:** 2 · Architecture · **Couche:** L5 Import

## Nom
Quote Extraction Engine

## Mission
Reconstruire un devis complet depuis un PDF.

## Vision
Le PDF importé est la seule vérité.

## Responsabilité unique
Reconstruire un devis complet depuis un PDF. — **une seule question**, aucune autre (Loi 1).
...
ExtractedQuote (dérivé)

## Objets utilisés
Document Analysis, AI, Branding, PDF
...
## Changelog
- 1.0 (2026-08-02) — Fiche initiale (L5 Import).
