...
## Mission
Analyser un document importé (texte, structure).

## Vision
Comprendre un PDF existant.

## Responsabilité unique
Analyser un document importé (texte, structure). — **une seule question**, aucune autre (Loi 1).

## Propriétaire
Document & Media (unique).
