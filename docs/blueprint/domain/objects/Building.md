...
## Mission
Un bâtiment/local d'un Site.

## Description
Un bâtiment/local d'un Site.

## Responsabilité
Responsabilité **unique** : Un bâtiment/local d'un Site. Aucune autre.
...
## Événements publiés
- `BuildingCreated` — déclencheur, consommateurs et impact : voir events/.
- `BuildingArchived` — déclencheur, consommateurs et impact : voir events/.
