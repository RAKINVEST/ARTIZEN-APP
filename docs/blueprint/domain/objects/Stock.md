...
## Mission
Le niveau de stock d'un Article.

## Description
Le niveau de stock d'un Article.

## Responsabilité
Responsabilité **unique** : Le niveau de stock d'un Article. Aucune autre.
...
## Objets liés
Article, Warehouse, PurchaseOrder
...
## Événements publiés
- `StockAdjusted` — déclencheur, consommateurs et impact : voir events/.

## Événements consommés
En principe aucun (les objets cœur publient ; les moteurs consomment). Voir events/.

## Contraintes
Un mouvement de stock est historisé (append-only) ; jamais négatif sans alerte.
