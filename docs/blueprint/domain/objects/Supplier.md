...
## Mission
Un fournisseur référencé pour les achats et le matériel.

## Description
Un fournisseur référencé pour les achats et le matériel.

## Responsabilité
Responsabilité **unique** : Un fournisseur référencé pour les achats et le matériel. Aucune autre.
...
## Événements publiés
- `SupplierCreated` — déclencheur, consommateurs et impact : voir events/.
- `SupplierUpdated` — déclencheur, consommateurs et impact : voir events/.

## Événements consommés
En principe aucun (les objets cœur publient ; les moteurs consomment). Voir events/.

## Contraintes
Jamais dupliqué ; référencé par id.
...
## Évolutions prévues
Connecteurs distributeurs (Ecosystem).
