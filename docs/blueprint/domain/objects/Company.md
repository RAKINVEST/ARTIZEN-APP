...
## Mission
Représenter l'entreprise artisanale et servir de racine de tenant.

## Description
Représenter l'entreprise artisanale et servir de racine de tenant.

## Responsabilité
Responsabilité **unique** : Représenter l'entreprise artisanale et servir de racine de tenant. Aucune autre.
...
## Objets liés
User, Branding, Template, toutes les données métier
...
## Événements publiés
- `CompanyCreated` — déclencheur, consommateurs et impact : voir events/.
- `CompanyUpdated` — déclencheur, consommateurs et impact : voir events/.

## Événements consommés
En principe aucun (les objets cœur publient ; les moteurs consomment). Voir events/.

## Contraintes
Racine de tenant : tout objet métier appartient à exactement une Company.
