...
## Mission
Un fait de domaine immuable — le seul canal cœur → moteurs.

## Description
Un fait de domaine immuable — le seul canal cœur → moteurs.

## Responsabilité
Responsabilité **unique** : Un fait de domaine immuable — le seul canal cœur → moteurs. Aucune autre.
...
## Objets liés
tout agrégat, moteurs read-side
...
## Contraintes
Immuable, versionné (`schema_version`) ; ne mute jamais un agrégat cœur (Loi 7).
