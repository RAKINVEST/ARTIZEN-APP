...
> **Version** 1.0 — **Status** Frozen — **Owner** Field Ops (futur) — **Last Update** 2026-08-02
...
## Mission
La garantie du matériel installé.

## Description
La garantie du matériel installé.

## Responsabilité
Responsabilité **unique** : La garantie du matériel installé. Aucune autre.
...
## Cycle de vie
Voir OBJECT_LIFECYCLE. Résumé : Active → ExpiringSoon → Expired | Claimed(SAV)
...
## Événements publiés
- `WarrantyRegistered` — déclencheur, consommateurs et impact : voir events/.
- `WarrantyExpiringSoon` — déclencheur, consommateurs et impact : voir events/.
- `WarrantyClaimed` — déclencheur, consommateurs et impact : voir events/.

## Événements consommés
En principe aucun (les objets cœur publient ; les moteurs consomment). Voir events/.

## Contraintes
La date de fin ne recule jamais ; alerte **avant** échéance, jamais après.
