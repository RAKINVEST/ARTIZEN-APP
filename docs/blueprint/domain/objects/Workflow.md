...
## Mission
Une procédure/checklist réutilisable.

## Description
Une procédure/checklist réutilisable.

## Responsabilité
Responsabilité **unique** : Une procédure/checklist réutilisable. Aucune autre.
...
## Événements publiés
- `WorkflowCreated` — déclencheur, consommateurs et impact : voir events/.
- `WorkflowUpdated` — déclencheur, consommateurs et impact : voir events/.

## Événements consommés
En principe aucun (les objets cœur publient ; les moteurs consomment). Voir events/.

## Contraintes
Décrit un enchaînement ; ne décide jamais à la place de l'artisan (Loi 7).
