...
## Mission
Une tâche planifiable au sein d'une Mission.

## Description
Une tâche planifiable au sein d'une Mission.

## Responsabilité
Responsabilité **unique** : Une tâche planifiable au sein d'une Mission. Aucune autre.
...
## Objets liés
Mission, Schedule, User

## Agrégats
Contenu dans l'agrégat **Mission**.
...
## Cycle de vie
Voir OBJECT_LIFECYCLE. Résumé : À faire → En cours → Faite

## États
À faire → En cours → Faite
...
## Événements publiés
- `TaskCreated` — déclencheur, consommateurs et impact : voir events/.
- `TaskCompleted` — déclencheur, consommateurs et impact : voir events/.

## Événements consommés
En principe aucun (les objets cœur publient ; les moteurs consomment). Voir events/.

## Contraintes
Appartient à une seule Mission.
