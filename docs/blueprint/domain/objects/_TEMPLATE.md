...
> **Version** 1.0 — **Status** Draft — **Owner** <Moteur propriétaire> — **Last Update** 2026-08-02
...
## Responsabilité
Responsabilité **unique** : <Mission en une phrase> Aucune autre.
...
## Moteur propriétaire
**<Moteur propriétaire>** (unique — Loi 1 ; aucun propriétaire secondaire).
...
## Événements publiés
- `<Name>Created` — déclencheur, consommateurs et impact : voir events/.
- `<Name>Updated` — déclencheur, consommateurs et impact : voir events/.
...
## Changelog
- 1.0 (2026-08-02) — Modèle de fiche (Agrégat racine).
