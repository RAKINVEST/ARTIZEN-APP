...
## Responsabilité
Responsabilité **unique** : Un véhicule de l'entreprise. Aucune autre.
...
## Événements publiés
- `VehicleCreated` — déclencheur, consommateurs et impact : voir events/.
