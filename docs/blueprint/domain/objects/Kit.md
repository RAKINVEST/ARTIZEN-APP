...
## Mission
Une préparation : composition d'éléments réutilisable, entièrement modifiable après insertion.

## Description
Une préparation : composition d'éléments réutilisable, entièrement modifiable après insertion.

## Responsabilité
Responsabilité **unique** : Une préparation : composition d'éléments réutilisable, entièrement modifiable après insertion. Aucune autre.
...
## Événements publiés
- `KitCreated` — déclencheur, consommateurs et impact : voir events/.
- `KitUpdated` — déclencheur, consommateurs et impact : voir events/.

## Événements consommés
En principe aucun (les objets cœur publient ; les moteurs consomment). Voir events/.

## Contraintes
Peut être vide ; ne contient aucune logique ; ne calcule aucun montant ; référence par id.
