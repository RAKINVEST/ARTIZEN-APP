...
## Mission
(NON un objet) — nom historique du contexte **Business Library**.

## Description
(NON un objet) — nom historique du contexte **Business Library**.

## Responsabilité
Responsabilité **unique** : (NON un objet) — nom historique du contexte **Business Library**. Aucune autre.
...
## Objets liés
Article, Kit, Phrase, Category, Supplier
...
## Contraintes
Ne jamais créer d'agrégat « Catalog » (fourre-tout interdit) — voir DOMAIN_ANTI_PATTERNS.
...
## Changelog
- 1.0 (2026-08-02) — Fiche initiale (Non-objet (contexte)).
