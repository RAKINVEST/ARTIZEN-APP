...
## Mission
Les indicateurs dérivés (5 temps, écarts, coût réel, rentabilité) — read-model (Vol.9).

## Description
Les indicateurs dérivés (5 temps, écarts, coût réel, rentabilité) — read-model (Vol.9).

## Responsabilité
Responsabilité **unique** : Les indicateurs dérivés (5 temps, écarts, coût réel, rentabilité) — read-model (Vol.9). Aucune autre.
...
## Objets liés
Mission, Intervention, Event, History
...
## Contraintes
Aucune écriture cœur (Loi 7) ; toute métrique est **explicable** (Loi 6) ; aucune comparaison entre entreprises.
