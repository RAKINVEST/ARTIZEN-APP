...
## Mission
Décrire un jeu de permissions attribuable à un User.

## Description
Décrire un jeu de permissions attribuable à un User.

## Responsabilité
Responsabilité **unique** : Décrire un jeu de permissions attribuable à un User. Aucune autre.
...
## Contraintes
Immuable ; égalité par valeur ; ne porte aucune donnée d'identité.
...
## Changelog
- 1.0 (2026-08-02) — Fiche initiale (Value Object).
