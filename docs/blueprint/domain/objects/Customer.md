...
> **Version** 1.0 — **Status** Frozen — **Owner** Client & Carnet — **Last Update** 2026-08-02
...
## Mission
Représenter un client et son carnet de santé (historique complet).

## Description
Représenter un client et son carnet de santé (historique complet).

## Responsabilité
Responsabilité **unique** : Représenter un client et son carnet de santé (historique complet). Aucune autre.
...
## Événements publiés
- `CustomerCreated` — déclencheur, consommateurs et impact : voir events/.
- `CustomerUpdated` — déclencheur, consommateurs et impact : voir events/.
- `CustomerArchived` — déclencheur, consommateurs et impact : voir events/.

## Événements consommés
En principe aucun (les objets cœur publient ; les moteurs consomment). Voir events/.

## Contraintes
Un carnet unique par client ; jamais dupliqué.
