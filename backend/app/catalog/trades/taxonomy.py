...
FAMILIES: tuple[Family, ...] = (
    ...
    Family(
        ...
        activities=(
            _e("piscine", "Piscine", _IMPL),
            _e("serrurerie-metallerie", "Serrurerie / Métallerie", _IMPL),
            _e("automatismes-portails", "Portails & automatismes", _IMPL),
            _e("vitrerie", "Vitrerie / Miroiterie", _IMPL),
            _e("ferronnerie", "Ferronnerie d'art", _IMPL),
            _e("paysagisme", "Paysagisme / Jardinier", _IMPL),
            _e("cloture", "Clôtures", _IMPL),
            _e("arrosage", "Arrosage automatique", _IMPL),
            _e("terrasse-bois", "Terrasse bois", _IMPL),
            _e("ascenseur", "Ascenseur", _IMPL),
            _e("ramonage", "Ramonage / Fumisterie", _IMPL),
            _e("desamiantage", "Désamiantage", _IMPL),
            _e("traitement-charpente", "Traitement de charpente / anti-nuisibles", _IMPL),
            _e("hygiene-nuisibles", "Hygiène / dératisation (3D)", _IMPL),
            _e("nettoyage", "Nettoyage / après-chantier", _IMPL),
            _e("diagnostic", "Diagnostic immobilier", _IMPL),
        ...
        exercise_qualifications=(_e("certification-amiante", "Certification amiante (SS4)", _IMPL),),
    ),
)
